<template>
  <b-card p-5>
    <b-card-header class="d-flex justify-content-between align-items-center">
      <b-card-title>Hiệu suất team sale-cskh</b-card-title>
      <div>
          ...
          <template slot="table-column" slot-scope="props">
            ...
            <span v-else-if="props.column.field == 'conversionRate'">
              ...
              <span class="badge bg-success fs-6">
                {{
                  Math.round(
                    (totalColumns.orderTotal / totalColumns.dataTotal || 0) *
                      100
                  )
                }}%
              </span>
...
export default {
  ...
  methods: {
    ...
    async getData() {
      await this.$callApi.get("/api/getReports/saleTeamMonth").then((res) => {
